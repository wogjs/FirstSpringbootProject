package com.firstProject.springBoot.config.auth.dto;
...
public class OAuthAttributes {
    ...
    //toEntity() : User 엔티티를 생성 OAuthAttributes에서 엔티티를 생성하는 시점은 처음 가입할 때임
    // 가입할 때의 기본 권한을 GUEST로 주기위해서 role 빌더값에는 Role.GUEST를 사용
