package com.firstProject.springBoot.web.domain.posts;
...
public class PostsRepositoryTest {
    ...
    // After:  Junit에서 단위 테스트가 끝날 때마다 수행되는 메소드를 지정
            ...
            // 여러 테스트가 동시에 수행되면 테스트용 디비인 H2에 데이터가 그대로 남아 있어 다음 테스트 실행 시 테스트가 실패할 수 있음
    ...
    public void 게시글저장_불러오기(){
        ...
        postsRepository.save(Posts.builder()
                .title(title)
                .content(content)
                .author("wogjs1152@gmail.com")
                .build());
        //postsRepository.save : 데이블 posts에 insert/update 쿼리를 실행
